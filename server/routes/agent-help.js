  ...
  res.json({
    ...
    endpoints: {
      ...
      schedules: {
        ...
        'POST /api/schedules': '创建单次排课，返回完整排课对象（含 class 字段）',
        'PUT /api/schedules/:id': '更新排课，返回完整排课对象；时间变更时自动重算 durationBilling',
        ...
        'GET /api/schedules/free-slots?start=YYYY-MM-DD&end=YYYY-MM-DD': '查询多日空闲时段（同样支持 after/before）',
    ...
    notes: [
      ...
      'free-slots 支持 after/before 参数限制查询时段（如 after=14:00&before=21:00），优先级高于 dayStart/dayEnd',
