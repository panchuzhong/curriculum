...
export default function BatchScheduleDialog({ onClose, onSaved }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50" onClick={onClose}>
      <div className="modal-enter bg-white dark:bg-gray-800 rounded-2xl p-6 w-[500px] max-h-[90vh] overflow-auto thin-scroll shadow-xl" onClick={e => e.stopPropagation()}>
